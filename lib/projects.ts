...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "EEG Seizure Detection Pipeline",
    subtitle: "Signal Processing & Classification for Brain Data",
    description:
      "End-to-end EEG processing pipeline with feature engineering, data balancing, and ML classification for seizure detection from the CHB-MIT dataset.",
    tags: [
      "Python",
      "Signal Processing",
      "scikit-learn",
    ...
    role: "ML Engineer & Data Pipeline Developer",
